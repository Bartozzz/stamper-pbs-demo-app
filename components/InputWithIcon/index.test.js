...
describe('Input Search', () => { 
    ...
    it('Render', () => {
        const component = mount(<InputIcon onChangeText={(e) => onChangeText(e)} />)
    ...
    describe('Interaction', () => {
        ...
        it('should have valid color if focused', () => {
            ...
            component.update();
            expect(getByTestID(component, "input-icon").last().prop('isFocused')).toBe(true);
            expect(getByTestID(component, "input-icon").last().prop('placeholderTextColor')).toBe(colors.color);
        });
        ...
        it('should have valid color if blurred', () => {
            ...
            component.update();
            expect(getByTestID(component, "input-icon").last().prop('isFocused')).toBe(false);
            expect(getByTestID(component, "input-icon").last().prop('placeholderTextColor')).toBe(colors.inputBorder);
        });
