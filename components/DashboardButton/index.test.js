...
describe('Dashboard Button', () => {
    ...
    describe('Render', () => {
        it('Shouldn`t have badge', () => {
            const component = mount(<DashboardButton icon={Icon} badge={0}>{exampleText}</DashboardButton>);
        ...
        it('Should have badge', () => {
            const component = mount(<DashboardButton icon={Icon} badge={1}>{exampleText}</DashboardButton>);
            const button = getByTestID(component, "button")
            const badge = getByTestID(component, "badge")
            const icon = getByTestID(component, "icon")
            const text = getByTestID(component, "text")
    ...
    describe('Interaction', () => {
        ...
        it('should change border onPressIn', () => {
            ...
            component.update();
            expect(getByTestID(component, "button").last().prop('style').borderColor).toBe(colors.primary);
        });
        ...
        it('should change border onPressOut', () => {
            ...
            component.update();
            expect(getByTestID(component, "button").last().prop('style').borderColor).toBe(colors.border);
        });
