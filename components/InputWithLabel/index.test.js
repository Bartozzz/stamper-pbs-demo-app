...
describe('Input Search', () => { 
    ...
    it('Render', () => {
        const component = mount(<InputWithLabel onChangeText={(e) => onChangeText(e)} />)
    ...
    describe('Interaction', () => {
        ...
        it('should have valid color if focused', () => {
            ...
            component.update();
            expect(getByTestID(component, "input-label-parent").last().prop('isFocused')).toBe(true);
            expect(getByTestID(component, "input-label-parent").last().prop('placeholderTextColor')).toBe(colors.color);
        });
        ...
        it('should have valid color if blurred', () => {
            ...
            component.update();
            expect(getByTestID(component, "input-label-parent").last().prop('isFocused')).toBe(false);
            expect(getByTestID(component, "input-label-parent").last().prop('placeholderTextColor')).toBe(colors.inputBorder);
        });
