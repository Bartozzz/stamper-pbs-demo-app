...
describe("Card", () => {
  ...
  it("should render action button", () => {
    const component = mount(
      <Card.Component
        title={title}
        subtitle={subtitle}
        renderPrimaryAction={() => <Text testID="primary-action">Test</Text>}
      />
    );
    ...
    const component = mount(
      <Card.Component
        ...
        renderSecondaryAction={() => (
          <Text testID="secondary-action">Test</Text>
        )}
      />
    );
  ...
  it("should render button", () => {
    const component = mount(
      <Card.Component
        title={title}
        subtitle={subtitle}
        renderButton={() => <Text testID="button">Test</Text>}
      />
    );
  ...
  it("should render title and subtitle should be in all caps", () => {
    const component = mount(
      <Card.Component title={title} subtitle={subtitle} />
    );
